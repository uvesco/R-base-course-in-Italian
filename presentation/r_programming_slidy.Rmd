...
`# installiamo il pacchetto swirl 3`
...
In questo caso, R ha calcolato la radice quadrata di ogni elemento del vettore z - 1. Quindi, la variabile my_sqrt conterrà un vettore con le radici quadrate dei singoli elementi del vettore z - 1. Le operazioni vettoriali in R sono molto utili perché consentono di applicare facilmente funzioni e operazioni matematiche a interi vettori senza dover utilizzare cicli o altre strutture di controllo.
